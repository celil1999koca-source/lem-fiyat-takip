...
# 1. Sayfa Ayarları
st.set_page_config(page_title="Alüminyum Ticari Takip", layout="wide")

# 2. Başlık
st.markdown("<h2 style='text-align: center;'>💼 Alüminyum Ticari Takip Paneli</h2>", unsafe_allow_html=True)
